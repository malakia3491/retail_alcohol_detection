<template>
  <section class="usage-report-page">
    ...
    <table v-else class="usage-table">
      ...
      <tbody>
        <template v-for="(StoreData, store) in report.rows" :key="store">
          <template v-for="(shelfData, shelf) in StoreData" :key="shelf">
            <template v-for="(row, storeId) in shelfData" :key="storeId">
              <tr>
